...
An owner-signed reference APK is attached to the [`v1.0.49` release](https://github.com/Hello-WS117/HabitTracker-redesign/releases/tag/v1.0.49). It is provided so a designer can inspect the current app without configuring a build environment.
